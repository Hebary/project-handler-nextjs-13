    ...
    return (
        <Layout>
            ...
            <Grid sx={{ maxWidth:'420px', mb:4, mx:'auto', p:4, borderRadius:5, boxShadow:'0 4px 6px -1px rgb(0 0 0 / 0.2), 0 2px 4px -2px rgb(0 0 0 / 0.2)', mt:1 }}>
             ...
             { contributor as User && (
                <Grid sx={{ display:'flex', alignItems:'center', width:'500px', mx:'auto', justifyContent:'space-between', gap:1, mb:2, borderRadius:3, p:3, boxShadow:'0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)', cursor:'pointer', ":hover":{ bgcolor:grey[100] }, transition: 'all .3s ease-in-out' }} item xs={12} md={10} >
